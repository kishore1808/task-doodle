...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form action="<?= base_url('Home/checkLogin');?>" method="post">
    <label class="checkbox-inline">
      <input type="radio" name="check"  value="1" checked> User
    </label>
    <label class="checkbox-inline">
      <input type="radio" name="check"  value="2"> Admin
    </label>
      
      <input type="text" id="mobile_no" class="fadeIn second" name="mobile_no" placeholder="Mobile Number">
